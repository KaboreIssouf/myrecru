...
class ContactFavoritesScreen extends StatefulWidget {
  const ContactFavoritesScreen({super.key});

  @override
  State<ContactFavoritesScreen> createState() => _ContactFavoritesScreenState();
}
class _ContactFavoritesScreenState extends State<ContactFavoritesScreen> {
